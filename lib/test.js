...
var ChessAI = function ChessAI(depth, game, isMaximisingPlayer) {
...
var minimax = function minimax(depth, game, isMaximisingPlayer) {
  if (depth === 0) {
  ...
  if (isMaximisingPlayer) {
    ...
    for (var _i = 0; _i < allMoves.length; _i++) {
      ...
      _bestValue = Math.min(_bestValue, minimax(depth - 1, game, !isMaximisingPlayer));
      _undo();
    }
    return _bestValue;
  }
...
var bestAI = new _index.AI(1, game, true);
